  ...
  render() {
    return (
      <Card small className="h-100">
        <CardBody
          className="py-0 more-padding"
          style={{ justifyContent: "center" }}
        >
        <div style={{ height: 500 }}>
          <div style={{ position: 'absolute', top: 20, right:20, zIndex: 1 }}>
            <Button outline pill theme="secondary" onClick={()=>this.openAddRangeDialog()}>
          ...
          >
            <DialogTitle disableTypography={true} style={{ fontFamily: 'sans-serif' }}>
          ...
          <div className="dashboard-card__header" style={{ fontSize: '.75rem' }}>WEEKLY SCHEDULE</div>
